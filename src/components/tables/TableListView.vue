    ...
    <div v-if="data" class="table-view">
        <div v-if="dataIsNotEmpty" class="table-wrapper">
                ...
                <tbody>
                    ...
                    >
                        ...
                        >
                            ...
                            <Decimal
                                v-else-if="isDecimal(itemKey)"
                                :value="item"
                            />
                            <MosaicsField
                                v-else-if="isMosaics(itemKey)"
                                :value="item"
                            />
                            <TransactionType
                            ...
                            />
                            <RestrictionField
                                v-else-if="itemKey === 'restrictions'"
                                :value="item"
                            />

                            <div
                                v-else-if="isAggregateInnerTransaction(itemKey)"
                            >
                                <b-link v-b-modal="'tlv_r' + rowIndex"
                                    >Show Detail</b-link
                                >
                                <Modal
                                    :id="'tlv_r' + rowIndex"
                            ...
                            <div v-else class="max-item-width">
                                ...
                                >
                                    <router-link
                                        ...
                                        @click.stop
                                    >
                                        <Truncate v-if="isTruncate(itemKey)">{{
                                            item
                                        }}</Truncate>
                                        <div v-else>
            ...
            <div v-if="pagination || timelinePagination" class="bottom">
                ...
                <div v-else>
                    {{ getPageNumber(timeline.index, timeline.pageNumber) }}/
                    {{ getPageNumber() }}
                </div>
                <div class="pagination-wrapper">
                    <Pagination
                        :can-fetch-previous="prevPageExist"
                        :can-fetch-next="nextPageExist"
                        :go-up="false"
                        class="pagination"
                        @next="nextPage"
                        @previous="prevPage"
                    />
                    <Loading v-if="paginationLoading" small />
                </div>
            </div>
        </div>
