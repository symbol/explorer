    ...
    <div>
        ...
        >
            <g id="account-1">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" fill="#460050" d="M220.535,269.897c0.11-2.393,1.469-4.188,2.864-5.965
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" fill="#460050" d="M262.636,307.188c-0.404-5.872-3.108-1.998-5.086-1.199
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" fill="#480152" d="M248.952,253.88c-6.989,0.567-10.491,6.707-6.721,15.414
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" fill="#4B0455" d="M268.638,294.191c-0.01-3.105-0.019-6.21-0.028-9.314
                    C270.451,287.976,270.092,291.082,268.638,294.191z"/>
                <path fill-rule="evenodd" clip-rule="evenodd" fill="#480152" d="M220.535,269.897c-0.188,1.731,0.723,3.677-0.999,5.107
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" fill="#4B0455" d="M263.409,293.948c-0.007-2.304,0.91-4.604,0.012-6.909
                    C265.29,289.346,265.243,291.647,263.409,293.948z"/>
                <path fill-rule="evenodd" clip-rule="evenodd" fill="#4B0455" d="M262.575,286.735c-1.953-1.662-0.281-3.851-0.831-5.717
                    C263.274,282.742,262.314,284.827,262.575,286.735z"/>
                <path fill-rule="evenodd" clip-rule="evenodd" fill="#4B0455" d="M261.379,297.931c0.693-1.358,1.386-2.718,2.079-4.076
            ...
            <g id="arrow">
                <g>
                    <line fill-rule="evenodd" clip-rule="evenodd" fill="#490553" x1="350" y1="318" x2="633" y2="318"/>
                    <g>
                        <line fill="none" stroke="#000000" stroke-width="5" stroke-miterlimit="10" x1="350" y1="318.5" x2="617" y2="318.5"/>
                        <g>
                            <polygon points="610.177,327.628 614.267,318 610.177,308.372 633,318 				"/>
                        </g>
                    </g>
                </g>
...
export default {
    data() {
        return {
            ...
            accountRecipient: 'TB3FPYTJSDSKE6T4OC4QQA2NBTRQFUXBYQ7253B2'
        }
    },
