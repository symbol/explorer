<template>
    ...
    >
        <defs>
            <linearGradient
                id="account-remove-circle-gradient"
                x1="0%"
                y1="0%"
                x2="100%"
                y2="100%"
        ...
        <g>
            <path
                fill="#FFFFFF"
                d="M27.36,25.503c-0.25-0.58-0.63-1.05-1.12-1.45c-0.851-0.7-1.83-1.149-2.87-1.47
            ...
            <rect
                x="18.577"
                y="9.542"
                transform="matrix(0.7067 0.7075 -0.7075 0.7067 19.2152 -7.9528)"
                fill="#FFFFFF"
                width="1.245"
                height="19.317"
            />
