<template>
	...
	>
		...
		<foreignObject x="446" y="318" width="100" height="100">
			<RestrictionMosaicListPopover :title="title" :target="this.id" :data="data" />
		</foreignObject>
		<circle
			fill-rule="evenodd"
			clip-rule="evenodd"
...
import RestrictionMosaicListPopover from './RestrictionMosaicListPopover.vue';

export default {
	extends: GraphicComponent,

	components: {
		RestrictionMosaicListPopover
	},
