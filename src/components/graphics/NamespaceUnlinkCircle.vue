<template>
    ...
    >
        <defs>
            <linearGradient
                id="namespace-circle-gradient"
                x1="0%"
                y1="0%"
                x2="100%"
                y2="100%"
            >
                <stop offset="0%" stop-color="RGB(177, 241, 255)" />
                <stop offset="100%" stop-color="RGB(5, 201, 255)" />
            </linearGradient>
        </defs>
        <foreignObject x="446" y="318" width="100" height="100">
            <NamespaceListPopover
                title="Unlinked namespace"
                :target="id"
        ...
        <circle
            fill-rule="evenodd"
            clip-rule="evenodd"
            fill="url(#namespace-circle-gradient)"
            cx="19.115"
            cy="19.094"
            r="17.26"
        />
        <g>
            <path
                fill="#FFFFFF"
                d="M19.71,11.86c-0.3-0.3-0.62-0.46-1.05-0.45c-0.91,0.01-1.66,0-2.66,0c0,0,0,0,0,0.01c-1,0-1.88-0.02-2.8,0
            ...
            <path
                fill="#FFFFFF"
                d="M26.97,21.27c-1.88,1.91-3.77,3.8-5.68,5.68c-0.66,0.65-1.58,0.61-2.24-0.05c-1.11-1.11-2.23-2.22-3.35-3.32
