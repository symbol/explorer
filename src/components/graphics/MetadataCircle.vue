<template>
	...
	>
		<defs>
			<linearGradient id="metadata-circle-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
				<stop offset="0%" stop-color="#B3E6B3" />
				<stop offset="100%" stop-color="#B3E6B3" />
			</linearGradient>
		</defs>
		...
		<circle
			fill-rule="evenodd"
			clip-rule="evenodd"
			fill="url(#metadata-circle-gradient)"
			cx="19.115"
			cy="19.094"
			r="17.26"
		/>
