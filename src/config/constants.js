...
class Constants {
  ...
  static NetworkConfig = {
    MOSAIC_RENTAL_FEE_SINK_ADDRESS : 'TBMOSAICOD4F54EE5CDMR23CCBGOAM2XSJBR5OLC',
    NAMESPACE_RENTAL_FEE_SINK_ADDRESS: 'TAMESPACEWH4MKFMBCVFERDPOOP4FK7MTDJEYP35',
    NAMESPACE : ['NEM','NEM.XEM'],
    NETWORKTYPE: NetworkType.TEST_NET,
    NEMESIS_TIMESTAMP: 1573426800
  }
