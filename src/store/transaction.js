...
export default {
    ...
    mutations: {
        ...
        setTimeline: (state, timeline) => {
            state[state.transactionType] = timeline
        },
        setTimelineWithType: (state, { timeline, type }) => {
            state[type] = timeline
        },
        ...
        transactionInfoLoading: (state, v) => {
            state.transactionInfoLoading = v
        },
        transactionInfoError: (state, v) => {
            state.transactionInfoError = v
        }
    },
    actions: {
        ...
        async getTransactionInfoByHash({ commit }, hash) {
            ...
            let transactionInfo
            try {
                transactionInfo = await sdkTransaction.getTransactionInfoFormatted(hash)
            } catch (e) {
                console.error(e)
