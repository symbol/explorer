...
export default {
    ...
    mutations: {
        ...
        setNamespaceInfo: (state, info) => {
            state.namespaceInfo = info
        },
        setNamespaceLevels: (state, levels) => {
            state.namespaceLevels = levels
        },
        namespaceInfoLoading: (state, v) => {
            state.namespaceInfoLoading = v
        },
        namespaceInfoError: (state, v) => {
            state.namespaceInfoError = v
        }
    },
    actions: {
        ...
        async fetchNamespaceInfo({ commit }, namespaceOrHex) {
            ...
            try {
                namespaceInfo = await sdkNamespace.getNamespaceInfoFormatted(namespaceOrHex)
            } catch (e) {
                console.error(e)
