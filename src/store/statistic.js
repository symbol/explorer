...
export default {
    ...
    getters: {
        ...
        getLoadingBlockTimeDifference: (state) =>
            state.loadingBlockTimeDifference,
        getLoadingTransactionPerBlock: (state) =>
            state.loadingTransactionPerBlock,
    ...
    actions: {
        ...
        async initializePage({ commit }) {
            ...
            try {
                ...
                const blocks = await BlockService.streamerBlocks(
                    searchCriteria,
                    240,
                );

                let blockTimeDifferenceDataset = StatisticService.getBlockTimeDifferenceData(
                    blocks,
                    240,
                    60,
                );
                ...
                commit(
                    'setBlockTimeDifferenceData',
                    blockTimeDifferenceDataset,
                );
                commit('setLoadingBlockTimeDifference', false);

                let transactionPerBlockDataset = StatisticService.getTransactionPerBlockData(
                    blocks,
                    240,
                    60,
                );
                ...
                commit(
                    'setTransactionPerBlockData',
                    transactionPerBlockDataset,
                );
