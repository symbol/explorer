			...
			<div class="container p-0 mt-5 t-c-p">
				<div class="row">
					<div class="col-md-12">
						...
						<p class="text-center">Effective date: October 01, 2019</p>
						<p>
						...
						<p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from http://www.nem.io/</p>
