...
describe('Symbol Explorer Blocks detail page', () => {
    ...
    describe('Block Detail Card should', () => {
        it('load title', () => {
            cy.get('[data-cy="blockDetailTitle"]').should(
                'contain',
                'Block Detail',
            );
        });
        ...
        it('render block pagination button', () => {
            cy.get(
                '[data-cy="blockDetailTitle"] [nextpageaction="block/nextBlock"]',
            ).should('have.length', 1);
            cy.get(
                '[data-cy="blockDetailTitle"] [previouspageaction="block/previousBlock"]',
            ).should('have.length', 1);
        });
    ...
    describe('Merkle Info Card should', () => {
        it('load title', () => {
            cy.get('[data-cy="merkleInfoTitle"]').should(
                'contain',
                'Merkle Info',
            );
        });
    ...
    describe('Block Transactions Card should', () => {
        it('load title', () => {
            cy.get('[data-cy="blockTransactionsTitle"]').should(
                'contain',
                'Block Transactions',
            );
        });
    ...
    describe('Balance Change Receipt Card should', () => {
        it('load title', () => {
            cy.get('[data-cy="balanceChangeReceiptTitle"]').should(
                'contain',
    ...
    describe('Resolution Statement Card should', () => {
        it('load title', () => {
            cy.get('[data-cy="resolutionStatementTitle"]').should(
                'contain',
